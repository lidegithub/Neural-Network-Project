 ...
 * @author Ega
 */
public class ForecastHybridFFNN {
    ...
    public ForecastHybridFFNN(){
    
    }
    
    public ForecastHybridFFNN(int weightInitialization, int numOfInputUnit, int numOfHiddenUnit, int numOfOutputUnit, double eta, double alpha, int maxEpoch, double maxError) {
    ...
    public double trainNN(double [][] V, double [][]W) {
    ...
    public static void main(String[] args) {
        ...
        double maxError = 0.5;
        int choice = 1;
        ForecastHybridFFNN ffnn = new ForecastHybridFFNN(choice,I,J,K,eta, alpha, maxEpoch, maxError);
