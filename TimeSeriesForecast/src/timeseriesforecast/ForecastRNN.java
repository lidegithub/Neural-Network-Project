...
public class ForecastRNN {
    ...
    public ForecastRNN(int weightInitialization, int numOfInputUnit, int numOfHiddenUnit, int numOfOutputUnit, double eta, double alpha, int maxEpoch, double maxError) {
    ...
    public static void main(String[] args) {
        ...
        double maxError = 0.5;
        int choice = 1;
        ForecastRNN rnn = new ForecastRNN(choice,I,J,K,eta, alpha, maxEpoch, maxError);
        ...
        System.out.println("size U"+U.length+"x"+U[0].length);
        double RMSE = rnn.trainNN(V, W, U);
        System.out.println("rmse rnn = "+RMSE);
    }
