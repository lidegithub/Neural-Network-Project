...
public class ForecastNN {
    ...
    public ForecastNN(int weightInitialization, int numOfInputUnit, int numOfHiddenUnit, int numOfOutputUnit, double eta, double alpha, int maxEpoch, double maxError) {
    ...
    public static void main(String[] args) {
        ...
        double maxError = 0.5;
        int choice = 1;
        ForecastNN ffnn = new ForecastNN(choice,I,J,K,eta, alpha, maxEpoch, maxError);
        ...
        System.out.println("rmse ffnn = "+RMSE);
    }
