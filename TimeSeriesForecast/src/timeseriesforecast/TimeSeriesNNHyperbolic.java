 ...
 * @author Ega
 */
public class TimeSeriesNNHyperbolic {
    ...
    public double[] TrainingNN(int choiceW, double[] trainingSet, int numOfInputUnit, int numOfHiddenUnit, int numOfOutputUnit, double eta, double alpha, int maxEpoch, double minForecastError) {
        /*
         * Learning in one-step forecast or multi-step forecast
         */
        FFNNHyperbolic ffnn = new FFNNHyperbolic(numOfInputUnit, numOfHiddenUnit, numOfOutputUnit, eta, alpha);
        ...
        while (stopCondition != true) {
            ...
            SE = TestingNN(trainingSet, numOfInputUnit, numOfHiddenUnit, numOfOutputUnit, eta, alpha);
    ...
    public double[] TestingNN(double[] testingSet, int numOfInputUnit, int numOfHiddenUnit, int numOfOutputUnit, double eta, double alpha) {
        ...
        double[] output = new double[numOfOutputUnit];
        double[] SE = new double[testingSet.length];
        for (int l = 0; l < (testingSet.length - numOfOutputUnit - numOfInputUnit); l++) {
            ...
            if (l == (testingSet.length - numOfOutputUnit - numOfInputUnit) - 1) {
                System.out.println("datapoint");
                ffnn.showVector(dataPoint);
                System.out.println(" ");
                System.out.println("outputD");
                ffnn.showVector(outputD);
                System.out.println("output");
                ffnn.showVector(output);
                System.out.println(" ");
                System.out.println("targetD");
                ffnn.showVector(targetD);
                System.out.println("target");
                ffnn.showVector(target);
                System.out.println("-----");
            }
