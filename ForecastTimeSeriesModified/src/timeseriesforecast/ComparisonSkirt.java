...
public class ComparisonSkirt {
    ...
    public ComparisonSkirt(int weightInitialization, int numOfInputUnit, int numOfHiddenUnit, int numOfOutputUnit, double eta, double alpha, int maxEpoch, double maxError) {
    ...
    public Vector getDataSetNYB() {
        ...
        try {
            ...
            code.addRCode("dataSet <- dmlist(\"22r4\")");
            code.addRCode("trainingSet <- dataSet[1:24,2]");
            code.addRCode("testingSet <- dataSet[25:35,2]");
            code.addRCode("validationSet <- dataSet[36:46,2]");
    ...
    public static void main(String[] args) {
        ...
        double maxError = 0.5;
        int choice = 1;
        ComparisonSkirt result1 = new ComparisonSkirt(choice, I1, J1, K1, eta, alpha, maxEpoch, maxError);
        double[][] experiment1 = result1.experiment1(choice, I1, J1, K1, eta, alpha, maxEpoch, maxError);

        int I2 = 3;
        int J2 = 5;
        int K2 = 1;
        ComparisonSkirt result2 = new ComparisonSkirt(choice, I2, J2, K2, eta, alpha, maxEpoch, maxError);
        double[][] experiment2 = result2.experiment1(choice, I2, J2, K2, eta, alpha, maxEpoch, maxError);

        int I3 = 3;
        int J3 = 5;
        int K3 = 3;
        ComparisonSkirt result3 = new ComparisonSkirt(choice, I3, J3, K3, eta, alpha, maxEpoch, maxError);
        double[][] experiment3 = result3.experiment1(choice, I3, J3, K3, eta, alpha, maxEpoch, maxError);

        int I4 = 6;
        int J4 = 12;
        int K4 = 1;
        ComparisonSkirt result4 = new ComparisonSkirt(choice, I4, J4, K4, eta, alpha, maxEpoch, maxError);
        double[][] experiment4 = result4.experiment1(choice, I4, J4, K4, eta, alpha, maxEpoch, maxError);

        int I5 = 6;
        int J5 = 12;
        int K5 = 4;
        ComparisonSkirt result5 = new ComparisonSkirt(choice, I5, J5, K5, eta, alpha, maxEpoch, maxError);
        double[][] experiment5 = result5.experiment1(choice, I5, J5, K5, eta, alpha, maxEpoch, maxError);

        int I6 = 4;
        int J6 = 6;
        int K6 = 1;
        ComparisonSkirt result6 = new ComparisonSkirt(choice, I6, J6, K6, eta, alpha, maxEpoch, maxError);
        double[][] experiment6 = result6.experiment1(choice, I6, J6, K6, eta, alpha, maxEpoch, maxError);

        int I7 = 6;
        int J7 = 4;
        int K7 = 3;
        ComparisonSkirt result7 = new ComparisonSkirt(choice, I7, J7, K7, eta, alpha, maxEpoch, maxError);
